...
#include "string/stringprintf.h"
#include "timer/time_format.h"
...
namespace libcommon {
    ...
    string FormatNanos(int32_t nanos) {
    ...
    string FormatTime(int64_t seconds, int32_t nanos) {
        DateTime time;
    ...
    bool ParseTime(const string& value, int64_t* seconds, int32_t* nanos) {
        DateTime time;

// https://raw.githubusercontent.com/examplecode/gfw_dns_resolver/master/gfw_dns_resolver.c
/**
...
void get_host_name(const char * domain, char * out)
{
     ...
     // error = getaddrinfo(domain, "http", &hints, &result);
